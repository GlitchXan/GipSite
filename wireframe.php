        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-xl-12">
              ...
              <p>Op deze website kan je informatie vinden over mijn GIP<br>
                Mijn GIP is een Chatprogramma.&nbsp;<br>
              </p>
              <img src="img/mario.png" class="mario" alt="Placeholder image">
              <p></p>
          ...
          <div class="col-md-4 col-12">
            <ul class="list-unstyled">
              <li class="media">
                <img class="mr-3" src="images/35X35.gif" alt="Generic placeholder image">
                <div class="media-body">
                  <h5 class="mt-0 mb-1">Chat programma</h5>
                Een simpel chatprogramma waarin je berichten kan sturen </div>
              </li>
            </ul>
          </div>
          <div class="col-md-4 col-12">
