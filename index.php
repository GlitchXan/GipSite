  ...
  <body>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-xl-12">
              <h1>Welkom</h1>
              <p>Welkom op mijn GIP site</p>
              <p>Op deze website kan je informatie vinden over de GIP van Xander<br>
                Mijn GIP is een Chatprogramma.&nbsp;<br>
              </p>
              
              <p>&nbsp;Als u meer informatie zoekt over mij kunt u deze vinden op de about me.&nbsp;</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <h1>Originele 3 ideeën</h1>
            <p>In het begin van dit schooljaar moesten we drie ideën voorstellen dat potentieel onzegip zouden kunnen zijn.<br>
            De leerkrachten zouden dan 1 van die drie ideën kiezen.&nbsp; </p>
            <p>&nbsp;Hieronder zie je de drie ideeën die ik heb voorgesteld.</p>
          </div>
        </div>
      </div>
    </section>
            ...
            <ul class="list-unstyled">
              <li class="media">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">Led Controller App</h5>
                  Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.
                </div><br>
			  </ul>
			  <img src="img/ledstrip.jpg" alt="ledstrip" class="mr-3"> 
          </div>
          ...
          <div class="col-md-4 col-12">
            <ul class="list-unstyled">
              <li class="media">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">Notepad App</h5>
                  Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.
                </div>
              </li>
            </ul>
			  <img src="img/notepad.png" alt="notepad" class="mr-3"> 
          </div>
			<div class="col-md-4 col-12">
            <ul class="list-unstyled">
              <li class="media">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">Chatapp</h5>
                  Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.
                </div>
			  </li>
            </ul>
				<img src="img/chat.png" alt="ledstrip" class="mr-3"> 
          </div>
        </div>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <h2>Door leerkracht gekozen</h2>
            <p>Uiteindelijk heeft mnr. Lippens gekozen voor de Chatapp.</p>
